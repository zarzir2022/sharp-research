...
Данный проект представляет собой исследовательскую работу по анализу доходности финансовых активов за трехлетний период (2021-2024 гг.) с применением современной портфельной теории Гарри Марковица. В рамках исследования были реализованы и протестированы методы оптимизации инвестиционных портфелей на исторических данных.
